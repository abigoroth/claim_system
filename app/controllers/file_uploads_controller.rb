class FileUploadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @file_upload.save
        format.html { redirect_to @file_upload.user_monthly_approval, notice: 'File upload was successfully created.' }
  ...
  def destroy
	@user_monthly_approval = UserMonthlyApproval.find(@file_upload.user_monthly_approval_id)
    @file_upload.destroy 
    respond_to do |format|
      format.html { redirect_to @user_monthly_approval, notice: 'File upload was successfully destroyed.' }
  ...
  private
    ...
    def file_upload_params
      params.require(:file_upload).permit(:user_monthly_approval_id , :upload_document)
    end
end
